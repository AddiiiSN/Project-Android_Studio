...
public class MainFragment extends BrowseSupportFragment {
    ...
    private void loadRows() {
        List<Video> list = VideoList.setupVideos();
        ...
        for (i = 0; i < NUM_ROWS; i++) {
            ...
            for (int j = 0; j < NUM_COLS; j++) {
                listRowAdapter.add(list.get(j % 3));
            }
            HeaderItem header = new HeaderItem(i, VideoList.VIDEO_CATEGORY[i]);
    ...
    private void setupUIElements() {
        ...
        setSearchAffordanceColor(ContextCompat.getColor(getActivity(), androidx.leanback.R.color.lb_tv_white));
    }
